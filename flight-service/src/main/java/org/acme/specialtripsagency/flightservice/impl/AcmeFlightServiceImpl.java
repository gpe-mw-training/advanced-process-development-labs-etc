...
@WebService(serviceName = "AcmeFlightService", endpointInterface = "org.acme.specialtripsagency.flightservice.AcmeFlightServiceInterface", targetNamespace = "urn:specialtripsagency.acme.org:flightservice")
